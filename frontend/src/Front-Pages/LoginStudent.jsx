                                    ...
                                    <div className="">
                                        <div className="h-15 my-8 relative">
                                            ...
                                            <input
                                                ...
                                                className={`pl-10 w-full py-2 border-b-2 text-black bg-white border border-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-500 ${formik.touched.username && formik.errors.username ? "border-red-500" : "border-black"
                                                    }`}
                                            />
                                        ...
                                        <div className="h-15 relative">
                                            ...
                                            <input
                                                ...
                                                onBlur={formik.handleBlur}
                                                value={formik.values.subject}
                                                className={`pl-10 w-full py-2 border-b-2 text-black bg-white border border-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-500 ${formik.touched.password && formik.errors.password ? "border-red-500" : "border-black"
                                                    }`}
                                            />
